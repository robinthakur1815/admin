<?php
	...
	if(
		...
		if($rows > 0){
			...
			$header->category2_name = $data->category2_name;
			$cate_data = $header->getcategory3();
		...
		#tell the user
		echo json_encode(array("message" => "Unable to get Category 3 Data. Data is incomplete.","status_code"=>400));
	}
