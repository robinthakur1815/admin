...
function prepareData($cmsShare,$result_adtype,$uniqid){
    ...
    foreach ($result_adtype as $key => $rowadtype) {
        ...
        @$sumuplevel_array[$AdType]['covg'] = $sumuplevel_arraymad[$AdType]['madreq'] > 0 ? number_format(($sumuplevel_arraymad[$AdType]['madreq']*100)/$sumuplevel_array[$AdType]['adreq'],1) :0.0;
        @$sumuplevel_array[$AdType]['ctr'] = $sumuplevel_array[$AdType]['adimpr'] > 0 ? number_format($click_array[$AdType]['clicks']/$sumuplevel_array[$AdType]['adimpr']*100,1):0.0;
        @$revenue_array[$AdType]['revenue_cmsShare']+=round($rowadtype['revenue']-($rowadtype['revenue']*$cmsShare),2);
        @$sumuplevel_array[$AdType]['ecpm'] = $sumuplevel_array[$AdType]['adimpr'] > 0 ? number_format($revenue_array[$AdType]['revenue_cmsShare']/$sumuplevel_array[$AdType]['adimpr']*1000,2) : 0.00;
    ...
    @$datalevel1inner[$AdType][$dateindex]['covg'] = $datalevel1innermad[$AdType][$dateindex]['madreq'] > 0 ? number_format(($datalevel1innermad[$AdType][$dateindex]['madreq']*100)/$datalevel1inner[$AdType][$dateindex]['adreq'],1) :0.0;
    @$datalevel1inner[$AdType][$dateindex]['ctr'] = $datalevel1inner[$AdType][$dateindex]['adimpr'] > 0 ? number_format($clicklevel1inner[$AdType][$dateindex]['clicks']/$datalevel1inner[$AdType][$dateindex]['adimpr']*100,1):0.0;
    @$revenuelevel1inner[$AdType][$dateindex]['revenue_cmsShare']+=round($rowadtype['revenue']-($rowadtype['revenue']*$cmsShare),2);
    @$datalevel1inner[$AdType][$dateindex]['ecpmx'] = $datalevel1inner[$AdType][$dateindex]['adimpr'] > 0 ? number_format($revenuelevel1inner[$AdType][$dateindex]['revenue_cmsShare']/$datalevel1inner[$AdType][$dateindex]['adimpr']*1000,2) : 0.00;
    ...
    @$sumuplevel2_array[$AdType][$repname]['ctr'] = $sumuplevel2_array[$AdType][$repname]['adimrlvl1'] > 0 ? number_format($click2_array[$AdType][$repname]['clickslvl1']/$sumuplevel2_array[$AdType][$repname]['adimrlvl1']*100,1):0.0;
    @$rev2_array[$AdType][$repname]['revenue_cmsSharelvl1']+=round($rowadtype['revenue']-($rowadtype['revenue']*$cmsShare),2);
    @$sumuplevel2_array[$AdType][$repname]['ecpmxlvl1'] = $sumuplevel2_array[$AdType][$repname]['adimrlvl1'] > 0 ? number_format($rev2_array[$AdType][$repname]['revenue_cmsSharelvl1']/$sumuplevel2_array[$AdType][$repname]['adimrlvl1']*1000,2) : 0.00;
    ...
    $filename = "Auxo_Network_Report_Display_Adtypes_".$uniqid.".csv";
