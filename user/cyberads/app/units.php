...
if(
 ...
 #tell the user data is incomplete
    ...
    #tell the user
    echo json_encode(array("message" => "Unable to get app ad unit. Data is incomplete.","status_code"=>400));
}
function prepareData($cmsShare,$result_adunit,$start,$end){
    ...
    @$datalevel2inner[$unitName][$dateindex]['fillrateinnerlvl1'] = number_format($datalevel2inner[$unitName][$dateindex]['adimrinnerlvl1']/$datalevel2inner[$unitName][$dateindex]['adrinnerlvl1']*100,1);
