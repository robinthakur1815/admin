...
if(
 ...
 #tell the user data is incomplete
    ...
    #tell the user
    echo json_encode(array("message" => "Unable to get app device. Data is incomplete.","status_code"=>400));
}
...
foreach($array_fulldate as $date_value)
{
    ...
    { 
        ...
        'covginnerlvl1'=> number_format(@$array_data[$date_value]['covginnerlvl1'],2),
        'clicksinnerlvl1'=> number_format(@$array_data[$date_value]['clicksinnerlvl1'],1),
