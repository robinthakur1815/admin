...
if(
 ...
 #tell the user data is incomplete
    ...
    #tell the user
    echo json_encode(array("message" => "Unable to get app geo. Data is incomplete.","status_code"=>400));
}
function prepareData($cmsShare,$result_geo,$start,$end){
 #Date Array
    ...
    foreach ($result_geo as $key => $rowgeo) {
        ...
        @$arraylevel3[$geo][$rowgeo['rep_name']][$rowgeo['date']]+=number_format($rowgeo['revenue']-($rowgeo['revenue']*$cmsShare),2);
