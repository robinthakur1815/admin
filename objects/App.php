...
class App{
 ...
 #database connection and table name
    ...
    public function getOverview(){
      ...
      if($table == "mcm_ad_exch_app_report"){
    ...
    public function getTableAdtype($tablename){
      ...
      switch ($tablename) {
        case "today":
          $this->table_adtype = "appadtype_today";
          break;
        case "yesterday":
          $this->table_adtype = "appadtype_yesterday";
          break;
        case "7days":
          $this->table_adtype = "appadtype_7days";
          break;
         case "10days":
          $this->table_adtype = "appadtype_10days";
          break; 
        case "last30days":
          $this->table_adtype = "appadtype_30days";
          break;
        case "thismonth":
          $this->table_adtype = "appadtype_thismonth";
          break;
        case "lastmonth":
          $this->table_adtype = "appadtype_previousmonth";
          break;
        case "3month":
          $this->table_adtype = "appadtype_3month";
          break;        
        default:
          $this->table_adtype = "mcm_adtypewise_app_report";
      }
    ...
    public function getAdtype(){
      ...
      #condtion for demo account 
      if($this->child_net_code == "demo_9999999"){
          $queryFetchAdtype = 'SELECT ad_type_date as date,ad_type,dfp_ad_unit as rep_name, mcm_clicks as clicks, mcm_adreq as adr, mcm_matchreq as madr, mcm_matchreq*100/mcm_adreq as covg, mcm_impression as adimr, mcm_earnings/mcm_impression*1000 as ecpmx, mcm_earnings as revenue FROM mcm_adtypewise_app_report_demo where child_net_code ="'.$this->child_net_code.'" AND ad_type_date between "'.$this->strtdate.'" and "'.$this->enddate.'" ORDER BY ad_type_date,revenue,ad_type DESC';
      }else{
      if($table == "mcm_adtypewise_app_report"){
    ...
    #get table name ad unit
    public function getTableAdunit($tablename){
      
      switch ($tablename) {
        case "today":
          $this->table_adunit = "appadunit_today";
          break;
        case "yesterday":
          $this->table_adunit = "appadunit_yesterday";
          break;
        case "7days":
          $this->table_adunit = "appadunit_7days";
          break;
        case "10days":
          $this->table_adunit = "appadunit_10days";
          break;  
        case "last30days":
          $this->table_adunit = "appadunit_30days";
          break;
        case "thismonth":
          $this->table_adunit = "appadunit_thismonth";
          break;
        case "lastmonth":
          $this->table_adunit = "appadunit_previousmonth";
          break;
        case "3month":
          $this->table_adunit = "appadunit_3month";
          break;        
        default:
          $this->table_adunit = "mcm_adunitwise_app_report";
      }
    ...
    public function getAdunits(){
      ...
      #condtion for demo account 
      if($this->child_net_code == "demo_9999999"){
            $queryFetchAdunit = 'SELECT ad_unitwise_date as date,"No Tag" as rep_name,dfp_ad_unit as unit_name,mcm_clicks as clicks, mcm_adreq as adr,mcm_matchreq as madr, mcm_matchreq*100/mcm_adreq as covg, mcm_impression as adimr, mcm_earnings/mcm_impression*1000 as ecpmx,mcm_earnings as revenue FROM mcm_adunitwise_app_report_demo where child_net_code ="'.$this->child_net_code.'" AND ad_unitwise_date between "'.$this->strtdate.'" and "'.$this->enddate.'" ORDER BY ad_unitwise_date DESC';
      }else{
      if($table == "mcm_adunitwise_app_report"){
    ...
    public function getTableSites($tablename){
      ...
      switch ($tablename) {
        case "today":
          $this->table_sites = "appsites_today";
          break;
        case "yesterday":
          $this->table_sites = "appsites_yesterday";
          break;
        case "7days":
          $this->table_sites = "appsites_7days";
          break;
         case "10days":
          $this->table_sites = "appsites_10days";
          break; 
        case "last30days":
          $this->table_sites = "appsites_30days";
          break;
        case "thismonth":
          $this->table_sites = "appsites_thismonth";
          break;
        case "lastmonth":
          $this->table_sites = "appsites_previousmonth";
          break;
        case "3month":
          $this->table_sites = "appsites_3month";
          break;        
        default:
          $this->table_sites = "mcm_domainwise_app_report";
      }
    ...
    public function getSites(){
      ...
      #condtion for demo account 
      if($this->child_net_code == "demo_9999999"){
          $queryFetchSites = 'SELECT ad_domain_date as date,site_name,dfp_ad_unit as rep_name,mcm_clicks as clicks, mcm_adreq as adr,mcm_matchreq as madr, mcm_matchreq*100/mcm_adreq as covg, mcm_impression as adimr, mcm_earnings/mcm_impression*1000 as ecpmx,mcm_earnings as revenue FROM mcm_domainwise_app_report_demo where child_net_code ="'.$this->child_net_code.'" AND ad_domain_date between "'.$this->strtdate.'" and "'.$this->enddate.'" ORDER BY revenue,ad_domain_date,site_name DESC';
      }else{
      if($table == "mcm_domainwise_app_report"){
    ...
    public function getTableDevice($tablename){
      ...
      switch ($tablename) {
        case "today":
          $this->table_device = "appdevice_today";
          break;
        case "yesterday":
          $this->table_device = "appdevice_yesterday";
          break;
        case "7days":
          $this->table_device = "appdevice_7days";
          break;
         case "10days":
          $this->table_device = "appdevice_10days";
          break; 
        case "last30days":
          $this->table_device = "appdevice_30days";
          break;
        case "thismonth":
          $this->table_device = "appdevice_thismonth";
          break;
        case "lastmonth":
          $this->table_device = "appdevice_previousmonth";
          break;
        case "3month":
          $this->table_device = "appdevice_3month";
          break;        
        default:
          $this->table_device = "mcm_devicecategory_app_report";
      }
    ...
    public function getDevice(){
      ...
      #condtion for demo account 
      if($this->child_net_code == "demo_9999999"){
         $queryFetchDevice = 'SELECT ad_device_date as date,device_category as device,dfp_ad_unit as rep_name,mcm_clicks as clicks, mcm_adreq as adr,mcm_matchreq as madr, mcm_matchreq*100/mcm_adreq as covg, mcm_impression as adimr, mcm_earnings/mcm_impression*1000 as ecpmx,mcm_earnings as revenue FROM mcm_devicecategory_app_report_demo where child_net_code ="'.$this->child_net_code.'" AND ad_device_date between "'.$this->strtdate.'" and "'.$this->enddate.'" ORDER BY revenue,ad_device_date,device_category DESC';
      }else{
      if($table == "mcm_devicecategory_app_report"){
    ...
    public function getTableGeo($tablename){
      ...
      switch ($tablename) {
        case "today":
          $this->table_geo = "appgeo_today";
          break;
        case "yesterday":
          $this->table_geo = "appgeo_yesterday";
          break;
        case "7days":
          $this->table_geo = "appgeo_7days";
          break;
        case "10days":
          $this->table_geo = "appgeo_10days";
          break;  
        case "last30days":
          $this->table_geo = "appgeo_30days";
          break;
        case "thismonth":
          $this->table_geo = "appgeo_thismonth";
          break;
        case "lastmonth":
          $this->table_geo = "appgeo_previousmonth";
          break;
        case "3month":
          $this->table_geo = "appgeo_3month";
          break;        
        default:
          $this->table_geo = "mcm_countrywise_app_report";
      }
    ...
    public function getGeo(){
      ...
      if($table == "mcm_countrywise_app_report"){
