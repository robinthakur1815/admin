...
if(
    ...
    if($rows > 0){
       ...
       $result_admanager = $salesUser->adManagerDomainData();
      
       $result_tag = $salesUser->tagStatusData();

       $result_sub = $salesUser->salesTeam();
       if(!empty($result_admanager)){
            ...
            $json_response = json_encode(array("data"=>$result_admanager,"assign to"=>$result_sub,"status_code"=>200));
